...
latex_documents = [
    (master_doc, 'PTMCMCSampler.tex', u'PTMCMCSampler Documentation',
...
man_pages = [
    (master_doc, 'PTMCMCSampler', u'PTMCMCSampler Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PTMCMCSampler', u'PTMCMCSampler Documentation',
     author, 'PTMCMCSampler', 'One line description of project.',
     'Miscellaneous'),
]
